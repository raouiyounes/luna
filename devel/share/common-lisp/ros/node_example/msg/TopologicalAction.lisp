...
(cl:defmethod cl:initialize-instance :after ((m <TopologicalAction>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TopologicalAction)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name node_example-msg:<TopologicalAction> is deprecated: use node_example-msg:TopologicalAction instead.")))
...
(cl:defmethod action-val ((m <TopologicalAction>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader node_example-msg:action-val is deprecated.  Use node_example-msg:action instead.")
  (action m))

(cl:ensure-generic-function 'src_id-val :lambda-list '(m))
(cl:defmethod src_id-val ((m <TopologicalAction>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader node_example-msg:src_id-val is deprecated.  Use node_example-msg:src_id instead.")
  (src_id m))

(cl:ensure-generic-function 'dest_id-val :lambda-list '(m))
(cl:defmethod dest_id-val ((m <TopologicalAction>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader node_example-msg:dest_id-val is deprecated.  Use node_example-msg:dest_id instead.")
  (dest_id m))

(cl:ensure-generic-function 'relative_rad-val :lambda-list '(m))
(cl:defmethod relative_rad-val ((m <TopologicalAction>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader node_example-msg:relative_rad-val is deprecated.  Use node_example-msg:relative_rad instead.")
  (relative_rad m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TopologicalAction>)))
  ...
  "node_example/TopologicalAction")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TopologicalAction)))
  "Returns string type for a message object of type 'TopologicalAction"
  "node_example/TopologicalAction")
