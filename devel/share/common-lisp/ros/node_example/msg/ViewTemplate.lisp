...
(cl:defmethod cl:initialize-instance :after ((m <ViewTemplate>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ViewTemplate)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name node_example-msg:<ViewTemplate> is deprecated: use node_example-msg:ViewTemplate instead.")))
...
(cl:defmethod current_id-val ((m <ViewTemplate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader node_example-msg:current_id-val is deprecated.  Use node_example-msg:current_id instead.")
  (current_id m))
