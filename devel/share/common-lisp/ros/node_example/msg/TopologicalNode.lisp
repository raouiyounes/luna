...
(cl:defmethod cl:initialize-instance :after ((m <TopologicalNode>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TopologicalNode)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name node_example-msg:<TopologicalNode> is deprecated: use node_example-msg:TopologicalNode instead.")))
...
(cl:defmethod pose-val ((m <TopologicalNode>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader node_example-msg:pose-val is deprecated.  Use node_example-msg:pose instead.")
  (pose m))
