...
if("TRUE" STREQUAL "TRUE")
  set(node_example_SOURCE_PREFIX /home/younes/Bureau/rospy1/src/node_example)
  set(node_example_DEVEL_PREFIX /home/younes/Bureau/rospy1/devel)
  ...
  set(node_example_INSTALL_PREFIX /home/younes/Bureau/rospy1/install)
...
if(NOT "/home/younes/Bureau/rospy1/devel/include " STREQUAL " ")
  set(node_example_INCLUDE_DIRS "")
  set(_include_dirs "/home/younes/Bureau/rospy1/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'node_example' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/younes/Bureau/rospy1/src/node_example/${idir}'.  Ask the maintainer 'Thomas Denewiler <tdenewiler@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/younes/Bureau/rospy1/devel/lib;/opt/ros/kinetic/lib)
...
set(node_example_EXPORTED_TARGETS "node_example_generate_messages_cpp;node_example_generate_messages_eus;node_example_generate_messages_lisp;node_example_generate_messages_nodejs;node_example_generate_messages_py;node_example_gencfg")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${node_example_dep}_FOUND)
      find_package(${node_example_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${node_example_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
