...
"""autogenerated by genpy from node_example/TopologicalMap.msg. Do not edit."""
import sys
...
float64 z"""
  ...
  _slot_types = ['std_msgs/Header','uint32','node_example/TopologicalNode[]','uint32','node_example/TopologicalEdge[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = node_example.msg.TopologicalNode()
        start = end
        end += 4
      ...
      self.edge = []
      for i in range(0, length):
        val1 = node_example.msg.TopologicalEdge()
        _x = val1
        start = end
        end += 12
